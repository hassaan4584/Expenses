...
public class AddExpense extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button expense_to_home=(Button) findViewById(R.id.add_expense_to_home);
		expense_to_home.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent i=new Intent(AddExpense.this,Home.class);
				startActivity(i);
