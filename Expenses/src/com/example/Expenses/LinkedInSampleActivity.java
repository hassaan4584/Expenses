...
import com.example.Expenses.LinkedinDialog.OnVerifyListener;
...
public class LinkedInSampleActivity extends Activity {
	...
	final LinkedInOAuthService oAuthService = LinkedInOAuthServiceFactory
            .getInstance().createLinkedInOAuthService(
            		LinkedinConfig.LINKEDIN_CONSUMER_KEY,LinkedinConfig.LINKEDIN_CONSUMER_SECRET, LinkedinConfig.scopeParams);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.linkedin_sample_activity);
		...
		share.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (null != share && !share.equalsIgnoreCase("")) {
					OAuthConsumer consumer = new CommonsHttpOAuthConsumer(LinkedinConfig.LINKEDIN_CONSUMER_KEY, LinkedinConfig.LINKEDIN_CONSUMER_SECRET);
...
//					name.setText("Welcome " +p.getHeadline());
//					Toast.makeText(getApplicationContext(), p.getEducations().toString(), Toast.LENGTH_LONG).show();
